...
unique_val_band1=data.B2Reft2.unique()
unique_val_band2= data.B3Reft3.unique()
unique_val_band3=data.B4Reft4.unique()
unique_val_band4= data.B5Reft5.unique()
unique_val_band5=data.B6Reft6.unique()
unique_val_band6= data.B7Reft7.unique()

unique_val_band1.sort()
...
dataset_band1.to_csv("visualize/band1.csv")
